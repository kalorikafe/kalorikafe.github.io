...
export const Hero: React.FC<HeroProps> = ({ onSelectQuickFilter, itemCount }) => {
  return (
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-2">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-stone-50/90 via-white to-[#F5EBE6] dark:from-[#241E1A] dark:via-[#1C1816] dark:to-[#171412] border border-stone-200/90 dark:border-stone-800/90 p-6 md:p-10 text-center space-y-6 shadow-xl dark:shadow-none">
        
        {/* Top Floating Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/90 dark:bg-stone-800/90 border border-[#6F4E37]/20 dark:border-[#D4B996]/30 text-[#6F4E37] dark:text-[#D4B996] text-xs font-black tracking-wide shadow-xs">
        ...
        {/* Main Heading */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-stone-900 dark:text-stone-50 tracking-tight leading-tight max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-2">
          ...
          <div className="p-4 rounded-2xl bg-white/90 dark:bg-stone-800/80 border border-stone-200/80 dark:border-stone-700/60 hover:border-[#6F4E37]/40 dark:hover:border-[#D4B996]/40 transition-all shadow-xs flex items-center gap-3.5 group">
            ...
            <div className="text-left">
              ...
              <div className="text-[11px] text-stone-500 dark:text-stone-400 font-semibold mt-0.5">{itemCount} Ürünlük Katalog</div>
            </div>
          </div>
        ...
        <div className="pt-3 border-t border-stone-200/60 dark:border-stone-800/60 max-w-3xl mx-auto">
          <div className="text-xs font-bold text-stone-500 dark:text-stone-400 mb-2.5 uppercase tracking-wider">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {[
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl bg-white dark:bg-stone-800/90 border border-stone-200 dark:border-stone-700 text-stone-800 dark:text-stone-200 text-xs font-bold hover:border-[#6F4E37] dark:hover:border-[#D4B996] hover:bg-[#6F4E37] hover:text-white dark:hover:bg-[#D4B996] dark:hover:text-[#2C221E] transition-all shadow-xs"
              >
                {pill.label}
              </button>
            ))}
