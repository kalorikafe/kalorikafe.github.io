...
export const SortAndAnalyticsBar: React.FC<SortAndAnalyticsBarProps> = ({
  ...
  return (
    <div className="flex min-w-0 flex-wrap items-center justify-between gap-3 overflow-hidden p-4 rounded-3xl bg-white dark:bg-[#1C1816] border border-stone-200 dark:border-stone-800 shadow-sm">
      
      {/* Sort Dropdown Left */}
      <div className="flex min-w-0 w-full items-center gap-2 sm:w-auto">
        <div className="flex shrink-0 items-center gap-1.5 text-xs font-black text-stone-700 dark:text-stone-300">
        ...
        <select
          ...
          className="min-w-0 flex-1 max-w-full px-3.5 py-2 rounded-2xl bg-stone-100 dark:bg-stone-800 border border-stone-200 dark:border-stone-700 text-stone-900 dark:text-stone-100 text-xs font-bold focus:outline-none focus:border-[#6F4E37] focus:ring-2 focus:ring-[#6F4E37]/20 sm:flex-none"
        >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3.5 py-2 rounded-2xl bg-[#2C221E] hover:bg-[#3D2B1F] dark:bg-[#FAF8F5] dark:hover:bg-stone-200 text-white dark:text-[#2C221E] font-black text-xs shadow-md border border-[#2C221E]/20 transition-all active:scale-95"
        >
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3.5 py-2 rounded-2xl border text-xs font-black transition-all ${
            showOnlyFavorites
              ...
              : 'bg-stone-100 dark:bg-stone-800 border-stone-200 dark:border-stone-700 text-stone-800 dark:text-stone-200 hover:bg-stone-200'
          }`}
        >
